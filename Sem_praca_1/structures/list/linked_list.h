...
namespace structures
{
	...
	inline int LinkedList<T>::getIndexOf(const T & data)
	{
		...
		//nepoužívam cyklus for, pretože for prebehne celé, ale viem to vyrieši breakom
		//kombinácia cyklu (On) a hranatých zátvoriek (On) mi dáva zložitos (On^2), preto sa 
		//tomu chceme vyhnú
