...
namespace structures
{
	...
	class List : public Structure, public Iterable<T>
		//List - abstraktná trieda (v jave je to interface), ktorá má abstraktné metódy
		//to sú virtuálne metódy, to sú tie ktoré majú const = 0
		//List je potomkom tried Structure a Iterable
	{
	public:
